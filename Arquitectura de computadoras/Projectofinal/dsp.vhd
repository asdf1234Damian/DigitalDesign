...
ENTITY lcd_controller IS
   PORT( 
	...
	--missing : std_logic_vector(7 downto 0);
	--line1_buffer : IN STD_LOGIC_VECTOR(63 downto 0); -- Data for the top line of the LCD
	--line2_buffer : IN STD_LOGIC_VECTOR(7 downto 0)); -- Data for the bottom line of the LCD
END lcd_controller;

ARCHITECTURE controller OF lcd_controller IS
  TYPE CONTROL IS(power_up, initialize, RESETLINE, line1, line2, send);
  SIGNAL    state      : CONTROL;
  constant undrscr : std_logic_vector(7 downto 0) := "01011111";
  CONSTANT  freq       : INTEGER := 133; --system clock frequency in MHz
  SIGNAL 	ptr     	  : natural range 0 to 8 := 7; -- To keep track of what character we are up to
  SIGNAL 	line		  : STD_LOGIC := '1';
  signal missing : std_logic_vector(7 downto 0);
  signal line1_buffer : STD_LOGIC_VECTOR(63 downto 0):= "0110000101100001011000010110000101100001011000010110000101100001"; -- Data for the top line of the LCD
  signal line2_buffer : STD_LOGIC_VECTOR(7 downto 0)); -- Data for the bottom line of the LCD;
  component OSCH
...
signal sigOSC: std_logic;
CONSTANT VEL: string := "133";-----------------Velocidad a modificar
...
BEGIN 
  ...
  IF(clk'EVENT and clk = '1') THEN 
      ...
      CASE state IS
        ...
        WHEN line1 =>
				line <= '1';
				if(ptr/=8 and missing(ptr)='1') then 
